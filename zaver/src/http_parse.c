...
int zv_http_parse_request_line(zv_http_request_t *r) {
    ...
    // BASLOG(LOG_LEVEL_DEBUG, "ready to parese request line, start = %d, last= %d", (int)r->pos, (int)r->last);
...
int zv_http_parse_request_body(zv_http_request_t *r) {
    ...
    //BASLOG(LOG_LEVEL_DEBUG, "ready to parese request body, start = %d, last= %d", r->pos, r->last);
